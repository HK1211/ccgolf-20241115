-- 통합 시퀀스(채번) 관리 테이블 생성
CREATE TABLE if not exists `CCGOLF`.`SHARED_CODE_SEQ_MANAGEMENT` (
...
-- 통합 코드관리 테이블 생성
CREATE TABLE if not exists `CCGOLF`.`SHARED_CODE_MANAGEMENT` (
...
-- 코드상세별 코드속성관리 테이블 생성
CREATE TABLE IF NOT EXISTS `CCGOLF`.`SHARED_CODE_DETAIL_ATTRIBUTE_MANAGEMENT` (
...
-- 프로그램관리 테이블 생성
CREATE TABLE IF NOT EXISTS `CCGOLF`.`SHARED_CODE_PROGRAM_MANAGEMENT` (
...
-- 메뉴관리 테이블 생성
CREATE TABLE IF NOT EXISTS `CCGOLF`.`SHARED_CODE_MENU_MANAGEMENT` (
...
CREATE TABLE IF NOT EXISTS `CCGOLF`.`SHARED_CODE_PERMISSION_GROUP` (
...
-- 권한 테이블: 권한 정보를 저장합니다.
CREATE TABLE IF NOT EXISTS `CCGOLF`.`SHARED_CODE_PERMISSION` (
...
CREATE TABLE IF NOT EXISTS `CCGOLF`.`SHARED_CODE_PERMISSION_GROUP_RELATION` (
...
CREATE TABLE IF NOT EXISTS `CCGOLF`.`SHARED_CODE_PERMISSION_GROUP_USER_RELATION` (
